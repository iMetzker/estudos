...
int main()
{
    ...
    printf("Calculadora de Viagem: Gasto de combustível e km percorrido.\n");
    ...
    printf("\nEm uma viagem à %.2f km/h durante %.2f horas,\nserão gastos %.2f litros de gasolina e o percurso total terá %.2f km\n", vel_media, tempo_viagem, gasolina_viagem, dist_viagem);
